...
public class ReuseAsyncUniMetricsTest {
    ...
    public void test(MyService service, MetricsAccess metrics) {
        ...
        assertThat(metrics.get(LongPointData.class, "ft.invocations.total", Attributes.of(
                stringKey("method"), "io.smallrye.faulttolerance.reuse.async.uni.metrics.MyService.first",
        ...
        assertThat(metrics.get(LongPointData.class, "ft.invocations.total", Attributes.of(
                stringKey("method"), "io.smallrye.faulttolerance.reuse.async.uni.metrics.MyService.second",
                stringKey("result"), "valueReturned",
                stringKey("fallback"), "applied"))
