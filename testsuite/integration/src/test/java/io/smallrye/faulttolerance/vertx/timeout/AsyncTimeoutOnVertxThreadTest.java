...
public class AsyncTimeoutOnVertxThreadTest extends AbstractVertxTest {
    ...
    private void timeout(MyService service, ExecutionStyle executionStyle) {
        ...
        assertThat(results).haveExactly(10, condition(it -> it instanceof TimeoutException));

        // 10 calls, for each of them: 1 before call + 1 before sleep + 1 after call
    ...
    private void noTimeout(MyService service, ExecutionStyle executionStyle) {
        ...
        // 10 calls, for each of them: 1 before call + 1 before sleep + 1 after sleep + 1 after call
