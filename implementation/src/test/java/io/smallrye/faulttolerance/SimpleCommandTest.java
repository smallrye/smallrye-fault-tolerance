...
public class SimpleCommandTest {
    ...
    public void testGetCommandKey() throws NoSuchMethodException, SecurityException {
        assertEquals("io_smallrye_faulttolerance_SimpleCommandTest#testGetCommandKey()",
                SimpleCommand.getCommandKey(SimpleCommandTest.class.getMethod("testGetCommandKey")));
        assertEquals("io_smallrye_faulttolerance_SimpleCommandTest$Foo#ping(java.lang.String,java.lang.Integer)",
                SimpleCommand.getCommandKey(Foo.class.getMethod("ping", String.class, Integer.class)));
        assertEquals("io_smallrye_faulttolerance_SimpleCommandTest$Foo#pong(java.util.List<java.lang.String>,T)",
