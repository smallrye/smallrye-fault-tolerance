...
public class ExceptionDecision {
    public static final ExceptionDecision ALWAYS_FAILURE = new ExceptionDecision(SetOfThrowables.ALL,
            SetOfThrowables.EMPTY, false);
    public static final ExceptionDecision ALWAYS_EXPECTED = new ExceptionDecision(SetOfThrowables.EMPTY,
            SetOfThrowables.ALL, false);

    public static final ExceptionDecision EMPTY = new ExceptionDecision(SetOfThrowables.EMPTY,
            SetOfThrowables.EMPTY, false);
    ...
    public ExceptionDecision(SetOfThrowables consideredFailure, SetOfThrowables consideredExpected, boolean inspectCauseChain) {
